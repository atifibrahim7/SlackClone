...
const styles = StyleSheet.create({
  ...
  unreadChannelRow: {
    paddingVertical: 3, // 40% reduced spacing for unread messages
  },
  channelTitle: {
    fontSize: 17,
    padding: 5,
...
export const SlackChannelList = () => {
  ...
  const renderChannelRow = (channel, isUnread = false) => (
    <View style={[styles.channelRow, isUnread && styles.unreadChannelRow]}>
  ...
  const renderSectionHeader = ({
    section: { clickHandler, data, id, title },
  }) => {
